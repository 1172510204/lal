...
public class PersonalAppEcosystemDifference extends Difference {

  // AF
  // PersonalAppEcosystemDifference不仅包含tracknums和trackNumberAndObjectsDif，
  // 还包含trackNumberAndName
  // RI
