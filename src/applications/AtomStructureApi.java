    ...
    while (true) {
      ...
      switch (m) {
        case 1:
          ...
          try {
            AtomStructure<CentralObject, PhysicalObject> a1 =
                (AtomStructure<CentralObject, PhysicalObject>) c;
        ...
        case 4:
          ...
          AtomStructure<CentralObject, PhysicalObject> atomStructure4 =
              (AtomStructure<CentralObject, PhysicalObject>) c;
        ...
        case 8:
          ...
          AtomStructure<CentralObject, PhysicalObject> atomStructure8 =
              (AtomStructure<CentralObject, PhysicalObject>) c;
