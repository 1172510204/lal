...
public class PersonalAppEcosystemApi {
  ...
  private void legal(CircularOrbit<CentralObject, PhysicalObject> c) {
    PersonalAppEcosystem<CentralObject, PhysicalObject> per =
        (PersonalAppEcosystem<CentralObject, PhysicalObject>) c;
    ...
    while (true) {
      ...
      switch (m) {
        ...
        case 4:
          ...
          logging.doLog("向编号:" + n4 + "半径:" + r4 + "的轨道上添加名字:" + appname4 + "的APP公司" + company4
              + "版本" + version4 + "功能" + function4 + "适用领域" + field4);
        ...
        case 8:
          ...
          PersonalAppEcosystemDifference diff =
              (PersonalAppEcosystemDifference) api8.getDifference(t81, t82);
          ...
          for (int i = 1; i <= eachNameMap.size(); i++) {
            System.out.print("轨道" + i + "的物体数量差异：");
            System.out.println(eachNumsMap.get(i) + "  物体差异：" + eachNameMap.get(i));
          }
          break;
        case 9:
          ...
          PersonalAppEcosystem<CentralObject, PhysicalObject> per9 =
              (PersonalAppEcosystem<CentralObject, PhysicalObject>) c;
          List<PhysicalObject> allObjects = per9.getAllObjects();
          PhysicalObject app91 = null;
          PhysicalObject app92 = null;
        ...
        case 10:
          ...
          Pattern patternt =
              Pattern.compile("<date>([0-9]{4}-[0-9]{2}-[0-9]{2})T([0-9]{2}:[0-9]{2}:[0-9]{2})");
          int i = 0;
          int flag = 0;
          int j = i;
                ...
                if (now != null && start != null && finish != null) {
                  if (now.after(start) && now.before(finish)) {
                    for (int k = j + 1; k < content.size(); k++) {
                      Pattern patternm =
                          Pattern.compile("<message>([a-zA-Z0-9\\u4e00-\\u9fa5\\.]*)</message>");
