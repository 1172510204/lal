...
public class Random implements Strategy {
   ...
   * @return a map key 组数 value a map key运动员 value 跑道编号 防御策略：pre-condition tracknums为4-10
   *         allAthlete不为空 post-condition 返回的map的组数正确
   */
  @Override
  public Map<Integer, Map<PhysicalObject, Integer>> competitionOrder(
    ...
    Map<Integer, Map<PhysicalObject, Integer>> order =
        new HashMap<Integer, Map<PhysicalObject, Integer>>();
    int flag = -1;
