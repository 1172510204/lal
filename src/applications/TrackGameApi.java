    ...
    while (true) {
      ...
      switch (m) {
        case 1:
          ...
          try {
            TrackGame<CentralObject, PhysicalObject> t1 =
        ...
        case 4:
          ...
          TrackGame<CentralObject, PhysicalObject> trackgame4 =
              (TrackGame<CentralObject, PhysicalObject>) makeGroup.get(g4);
        ...
        case 6:
          ...
          TrackGame<CentralObject, PhysicalObject> trackgame6 =
              (TrackGame<CentralObject, PhysicalObject>) makeGroup.get(g6);
        ...
        case 8:
          ...
          for (Integer num : groupMap.keySet()) {
            TrackGame<CentralObject, PhysicalObject> k =
                new TrackGame<CentralObject, PhysicalObject>();
            try {
        ...
        case 9:
          ...
          int flag1 = 0;
          int flag2 = 0;
          PhysicalObject ath1 = null;
          PhysicalObject ath2 = null;
